...
export async function GenerateWANAiVideos(prompt: string, loginEmail: string, loginPassword: string, emailToSendVideo: string, webhookUrl: string, videoTitle: string, rowNumber: number = 0) {
